...
class PerformanceMonitor:
    ...
    def _init_loggers(self):
        ...
        logger.info(f"[STATS] Monitoring logs:")
    ...
    def _save_hardware_specs(self):
        ...
        logger.info(f"[SAVE] Hardware specs saved: {specs_file}")
            ...
            if self.profile.system == "Darwin":  # macOS
                ...
                for line in result.stdout.split('\n'):
                    if 'CPU die temperature' in line:
                        try:
                            return float(line.split()[-1].rstrip('°C'))
                        except:
                            pass
    ...
    def export_analysis(self) -> dict:
        ...
        logger.info(f"[STATS] Analysis exported: {analysis_path}")
        return analysis
