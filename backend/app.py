...
if sys.platform == "darwin":  # macOS
    try:
        ...
        print(f"[WARN] macOS optimizations not available: {e}")
...
async def list_emotions():
    ...
    [WARN]️ IMPORTANT: Fish Speech is a VOICE CLONING model, not emotion-controlled TTS.
    ...
    """
    return {
        'note': '[WARN] Emotions come from your REFERENCE AUDIO, not text tags!',
        'how_to_add_emotion': {
...
async def get_hardware_profile():
    ...
    return {
        ...
        "selected_configuration": {
            ...
            "use_onnx": config.useonnx,
            "use_torch_compile": config.usetorchcompile,
...
if __name__ == "__main__":
    ...
    print("="*70)
    print("Features:")
    print("  [OK] Automatic hardware detection")
    print("  [OK] Self-optimizing configuration")
    print("  [OK] Real-time resource monitoring")
    print("  [OK] Adaptive performance tuning")
    print("="*70)
